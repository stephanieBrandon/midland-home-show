// ==========================================
// MIDLAND SPRING HOME SHOW - JAVASCRIPT
// ==========================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    galleryItems.forEach(item => {
        item.addEventListener('click', function() {
            ...
            // You can add a lightbox library or custom modal here
    ...
    // ==========================================
    console.log('%c🎪 Midland Spring Home Show 2026', 'color: #4A8B8B; font-size: 20px; font-weight: bold;');
    console.log('%cSupporting Shriners Children\'s and Georgian Bay General Hospital', 'color: #FF8C42; font-size: 14px;');
